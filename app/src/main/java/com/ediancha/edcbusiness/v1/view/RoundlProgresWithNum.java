package com.ediancha.edcbusiness.v1.view;
...
public class RoundlProgresWithNum extends CustomHorizontalProgresNoNum {
    ...
    private static final int DEAFUALT_PROGRESS_RADIO = 58;//圆的半径
    private static final int DEAFUALT_PROGRESS_UNREACH_PAINT_STROKEN = 2;//未走完进度的宽度
    private static final int DEAFUALT_PROGRESS_REACH_PAINT_STROKEN = 2;//走完进度的宽度
