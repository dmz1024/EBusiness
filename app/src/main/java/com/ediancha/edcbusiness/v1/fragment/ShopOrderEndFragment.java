...
public class ShopOrderEndFragment extends BaseFragment<ShopOrderDataBean.Data,ShopOrderDataBean> {


    public static ShopOrderEndFragment newInstance(){

        return new ShopOrderEndFragment();
    }
    @Override
